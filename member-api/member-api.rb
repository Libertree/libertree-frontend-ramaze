...
module Libertree
  class ValidateNonEmpty < Grape::Validations::Validators::Base
  ...
  class ValidateUrlsNotPosted < Grape::Validations::Validators::Base
    def validate_param!(attr_name, params)
  ...
  class ValidatePositiveInteger < Grape::Validations::Validators::Base
    def validate_param!(attr_name, params)
